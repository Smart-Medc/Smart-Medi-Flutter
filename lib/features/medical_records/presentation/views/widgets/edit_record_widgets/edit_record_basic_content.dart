...
class _EditRecordBasicContentState extends State<EditRecordBasicContent> {
  ...
  final TextEditingController _findingSummaryController = TextEditingController();
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextFormField(
                  ...
                  validator: (value) => Validator.requiredValidator(value, 'Please enter a record title'),
                ...
                CustomTextFormField.dropdown(
                  ...
                  validator: (value) => Validator.requiredValidator(value, 'Please select a record type'),
                ...
                CustomTextFormField.date(
                  ...
                  validator: (value) => Validator.requiredValidator(value, 'Please select a start date'),
                  hintText: '03/10/2024',
                ),
                16.verticalSpace,
                ...
                TextFormField(
                  ...
                  maxLines: 2,
                  decoration: InputDecoration(
                    hintText: 'Findings summary for the chest X-ray imaging study.',
                    hintStyle: AppStyles.textStyle12W400DarkGrey,
                    filled: true,
                    fillColor: AppColors.formFieldBGColor,
                    enabledBorder: OutlineInputBorder(
